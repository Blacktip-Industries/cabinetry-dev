<?php
/**
 * Inventory Component - Create Item
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $result = inventory_create_item($itemData);
...
<head>
    ...
    <title>Create Item - Inventory</title>
            ...
            <div class="inventory__section">
                <form method="POST" class="inventory__form">
                    <div class="inventory__form-group">
                        ...
                        <input type="text" name="item_code" class="inventory__input" value="<?php echo htmlspecialchars($_POST['item_code'] ?? ''); ?>" required>
                        <small class="inventory__help">Unique identifier for this item</small>
                    </div>
                    
                    <div class="inventory__form-group">
                        <label class="inventory__label">Item Name *</label>
                        <input type="text" name="item_name" class="inventory__input" value="<?php echo htmlspecialchars($_POST['item_name'] ?? ''); ?>" required>
                    </div>
                    
                    <div class="inventory__form-group">
                        <label class="inventory__label">Description</label>
                        <textarea name="description" class="inventory__textarea" rows="4"><?php echo htmlspecialchars($_POST['description'] ?? ''); ?></textarea>
                    </div>
                    
                    <div class="inventory__form-group">
                        <label class="inventory__label">SKU</label>
                        <input type="text" name="sku" class="inventory__input" value="<?php echo htmlspecialchars($_POST['sku'] ?? ''); ?>">
                        <small class="inventory__help">Stock Keeping Unit (optional)</small>
                    </div>
                    
                    <div class="inventory__form-row">
                        <div class="inventory__form-group">
                            <label class="inventory__label">Category</label>
                            <input type="text" name="category" class="inventory__input" value="<?php echo htmlspecialchars($_POST['category'] ?? ''); ?>" list="categories">
                        ...
                        <div class="inventory__form-group">
                            ...
                            <select name="unit_of_measure" class="inventory__select">
                                <option value="unit" <?php echo ($_POST['unit_of_measure'] ?? 'unit') === 'unit' ? 'selected' : ''; ?>>Unit</option>
                                <option value="kg" <?php echo ($_POST['unit_of_measure'] ?? '') === 'kg' ? 'selected' : ''; ?>>Kilogram</option>
                                <option value="g" <?php echo ($_POST['unit_of_measure'] ?? '') === 'g' ? 'selected' : ''; ?>>Gram</option>
                                <option value="L" <?php echo ($_POST['unit_of_measure'] ?? '') === 'L' ? 'selected' : ''; ?>>Liter</option>
                                <option value="mL" <?php echo ($_POST['unit_of_measure'] ?? '') === 'mL' ? 'selected' : ''; ?>>Milliliter</option>
                                <option value="m" <?php echo ($_POST['unit_of_measure'] ?? '') === 'm' ? 'selected' : ''; ?>>Meter</option>
                                <option value="cm" <?php echo ($_POST['unit_of_measure'] ?? '') === 'cm' ? 'selected' : ''; ?>>Centimeter</option>
                    ...
                    <div class="inventory__form-group">
                        ...
                        <div class="inventory__form-row">
                            <div class="inventory__form-group">
                                ...
                                <input type="number" name="commerce_product_id" class="inventory__input" value="<?php echo htmlspecialchars($_POST['commerce_product_id'] ?? ''); ?>" min="1">
                            </div>
                            <div class="inventory__form-group">
                                <label class="inventory__label">Commerce Variant ID</label>
                                <input type="number" name="commerce_variant_id" class="inventory__input" value="<?php echo htmlspecialchars($_POST['commerce_variant_id'] ?? ''); ?>" min="1">
                            </div>
                        </div>
                        <small class="inventory__help">Link this item to a commerce product (optional)</small>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="inventory__form-actions">
                        <button type="submit" class="inventory__button inventory__button--primary">Create Item</button>
